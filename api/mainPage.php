...
<head>
  ...
  <script src="https://kit.fontawesome.com/076516437a.js" crossorigin="anonymous"></script>
...
<body>
  <div class="page">
    <div class="menu">
      <div class="menu_logo">
        <img src="https://lh3.googleusercontent.com/u/0/d/1BztHznYZ5NnudZ0HIE3dOwI6VvcMVy_r=w1366-h653-iv1" alt="" />
      </div>
      <nav class="menu_pestaña">
        <ul>
          <li>
            <div class="menu_pestaña_elememt" id="menu_pestaña_elememt_inicio" data-url="../Inicio.html">
              &nbsp;
          ...
          <li>
            <div class="menu_pestaña_elememt" id="menu_pestaña_elememt_categorias" 
          ...
          <li>
            <div class="menu_pestaña_elememt"  data-url="../api/Carrito.php?correo_usuario=<?php echo urlencode($_COOKIE['correo_usuario']); ?>">
